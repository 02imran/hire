...
class SellerRecordedTransactionBody extends StatelessWidget {
  @override
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Text('Delivery time: 120,000', style: TextStyle(fontSize: 10)),
